module.exports = class BM25 {
    ...
    constructor(k1: number = 1.2, k3: number = 1.2, b: number = 0.75) {
        this.k1 = k1;
        this.k3 = k3;
        this.b = b;
    }
    ...
    // 计算单词与某个文档的相关性
    getCorrelationToDocument(document: string[], word: string, documentsAvgLength: number) {
    ...
    // 计算单词与query的相关性
    getCorrelationToQuery(word: string) {
        // 计算单词在query的词频
    ...
    getQueryCorrelationToDocument(document: string[], documentsAvgLength: number) {
        // query对于某个文档的相关性
    ...
    getCorrelation() {
        const correlations: { id: number; correlation: number }[] = []
        // 所有文档的平均长度
